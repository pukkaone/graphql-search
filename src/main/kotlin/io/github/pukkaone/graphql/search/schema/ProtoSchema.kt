...
private const val DIRECTIVE_DEFINITIONS = """
    # Marks an object to be transformed into an search index mapping.
    directive @document on OBJECT

    # Marks a field contains the document ID.
    directive @id on FIELD_DEFINITION

    # Marks a field can be queried in a search.
...
private fun parseSchemaFiles(filePattern: String): TypeDefinitionRegistry {
    ...
    typeDefinitionRegistry.merge(schemaParser.parse(DIRECTIVE_DEFINITIONS))
