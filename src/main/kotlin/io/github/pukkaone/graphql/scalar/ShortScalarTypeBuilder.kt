...
/**
 * Custom GraphQL scalar type that produces java.lang.Short objects at runtime.
 */
@AutoService(GraphQLScalarTypeBuilder::class)
class ShortScalarTypeBuilder : GraphQLScalarTypeBuilder {
        ...
        return GraphQLScalarType.newScalar(ExtendedScalars.GraphQLShort)
            .definition(
                ScalarTypeDefinition.newScalarTypeDefinition()
                    .name(ExtendedScalars.GraphQLShort.name)
                    .build()
            )
            .build()
    }
