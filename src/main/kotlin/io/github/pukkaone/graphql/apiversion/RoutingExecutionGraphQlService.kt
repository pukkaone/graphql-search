...
import io.github.pukkaone.graphql.search.AggregateDataFetcher
import io.github.pukkaone.graphql.search.AggregateDocumentsUseCase
...
class RoutingExecutionGraphQlService(
    ...
    private val aggregateDocumentsUseCase: AggregateDocumentsUseCase,
            ...
            for (documentType in protoSchema.documentTypes) {
                ...
                runtimeWiringBuilder.type("Query") { typeBuilder ->
                    ...
                    typeBuilder.dataFetcher(
                        ...
                        AggregateDataFetcher(aggregateDocumentsUseCase)
                    )
                    typeBuilder.dataFetcher(
