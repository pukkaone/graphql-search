...
class FilterTest : IntegrationTestSupport() {
    ...
    fun `when filter contains then find hit`() {
        val transactions = graphQlTester
            .document(
                """
                query {
                  transactionSearch(
            ...
            .execute()
            .path("transactionSearch.edges[*].node.transaction_urn")
            .entityList(String::class.java)
        assertThat(transactions.get()).containsExactly("transaction:1")
    }
    ...
    fun `when filter exists false then find hit`() {
        val transactions = graphQlTester
            ...
            .path("transactionSearch.edges[*].node.transaction_urn")
            .entityList(String::class.java)
        assertThat(transactions.get()).containsExactly("transaction:2")
    }
    ...
    fun `when filter exists true then find hit`() {
        val transactions = graphQlTester
            ...
            .path("transactionSearch.edges[*].node.transaction_urn")
            .entityList(String::class.java)
        assertThat(transactions.get()).containsExactlyInAnyOrder("transaction:1", "transaction:3")
    }

    @Test
    fun `when filter geoDistance then find hit`() {
        val transactions = graphQlTester
            .document(
                """
                query {
            ...
            .path("transactionSearch.edges[*].node.transaction_urn")
            .entityList(String::class.java)
        assertThat(transactions.get()).containsExactlyInAnyOrder("transaction:1", "transaction:2", "transaction:3")
    }
    ...
    fun `when filter gt then find hit`() {
        val transactions = graphQlTester
            ...
            .path("transactionSearch.edges[*].node.transaction_urn")
            .entityList(String::class.java)
        assertThat(transactions.get()).containsExactlyInAnyOrder("transaction:2", "transaction:3")
    }
    ...
    fun `when filter in then find hit`() {
        val transactions = graphQlTester
            ...
            .path("transactionSearch.edges[*].node.transaction_urn")
            .entityList(String::class.java)
        assertThat(transactions.get()).containsExactlyInAnyOrder("transaction:1", "transaction:2")
    }
